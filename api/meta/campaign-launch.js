...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (action === 'create') {
      ...
      res.status(200).json(await doCreate(slug, launchId, { objective: body.objective, days: body.days, dailyBudget: body.dailyBudget, promote: body.promote, productId: body.productId }));
      return;
    }
