  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="border-b border-gray-100 bg-white/90 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-3xl mx-auto px-4 h-14 flex items-center gap-3">
          <Link to="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
            <img src="/seniqify-logo.png" alt="Seniqify" className="h-8 w-auto" />
          </Link>
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-sm prose-gray max-w-none space-y-8 text-gray-700">
          ...
          <section>
            ...
            <p>
              By accessing or using Seniqify ("the Platform"), you agree to be bound by these Terms
          ...
          <section>
            ...
            <p>
              Seniqify allows Indian businesses to create a storefront page and receive product
          ...
          <section>
            ...
            <p>
              The Seniqify brand, logo, and Platform code are owned by us. Store owners retain
          ...
          <section>
            ...
            <p>
              To the maximum extent permitted by law, Seniqify shall not be liable for any
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:seniqify@gmail.com" className="text-teal-600 hover:underline">
                seniqify@gmail.com
              </a>.
            </p>
          </section>
      ...
      <footer className="border-t border-gray-100 px-4 py-6 text-center text-xs text-gray-400">
        <Link to="/" className="hover:text-gray-700 transition-colors">← Back to Seniqify</Link>
