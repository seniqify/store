 ...
 * ─────────────────────────────────────────────────────────────────────────────
 * Shown when:
 *   • A slug in the URL doesn't match any registered business
 *   • User navigates to a completely unknown path
 *
 * Props:
        ...
        <p className="text-gray-500 text-sm mb-8 leading-relaxed">
          {slug ? (
            <>
              ...
              . Try one of the stores below.
            </>
          ) : (
            'Please enter a valid store URL, e.g. /softweave'
          )}
        </p>
